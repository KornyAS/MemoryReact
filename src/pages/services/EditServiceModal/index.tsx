...
import { useServiceToEdit } from "../../../store/services/hooks";
...
const EditServiceModal = () => {
  ...
  const editServiceModal = useEditServiceModal();
  const serviceToEdit = useServiceToEdit();
  ...
  useEffect(() => {
    setInputs({
      name: serviceToEdit.ServiceTitle,
      description: serviceToEdit.ServiceDescription,
    });
    setComplects(serviceToEdit.complectation);
  }, [serviceToEdit]);
  ...
  const handleCreateService = async (e: any) => {
    ...
    form.append("ID", serviceToEdit.ID);

    // form.append("image", read);
    try {
      const res = await API.post("/services.php", form, {
  ...
  return (
    <Transition.Root show={editServiceModal.open} as={Fragment}>
      <Dialog
        as="div"
              ...
              <form className="m-6 flex flex-col items-center">
                ...
                <div className="flex justify-between mt-6  w-full">
                  <div className="w-80 h-56 flex flex-col items-center justify-center bg-slate-300 rounded-2xl">
                    ...
                    serviceToEdit.images[0].URL ? (
                      <img
                        className="w-full h-full object-cover"
                        src={serviceToEdit.images[0].URL}
                        alt=""
                      />
                    ) : (
                      <>
